				...
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
						...
						<?php if(!$_SESSION['home_userid']){ ?>
							<li class="active"><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i><a class="act" href="login.php">登录</a></li>
...
<!-- login -->
	<div class="login">
		<div class="container">
			<p class="est animated wow zoomIn" data-wow-delay=".5s">如果您有账号请登录，如果没有账号请注册之后再登录！</p>
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form action="./api/checklogin.php" method="post">
					<input type="email" placeholder="用户名" required=" " name="username" >
			...
			<h4></h4>
			<p class="animated wow slideInUp" data-wow-delay=".5s">新用户点击这里<a href="register.html">注册</a> (或者) 返回 <a href="index.php">首页<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
<!-- footer -->
